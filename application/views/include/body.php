                    ...
                    <form role="form" class="form-horizontal">
                        <div class="form-body">
                            <div class="form-group form-md-line-input">
                                <label class="col-md-3 control-label" for="form_control_1">Nama Toko</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="form_control_1" readonly="" value="Enter your name">
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" rows="3" readonly="" value="Enter your name"></textarea>
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>
                            <div class="form-group form-md-line-input">
                            ...
                            <div class="form-group form-md-line-input ">
                                <label class="col-md-3 control-label" for="form_control_1">Kota</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="form_control_1" readonly="" value="Enter your name">
                                    <div class="form-control-focus"> </div>
                                </div>
                            ...
                            <div class="form-group form-md-line-input ">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" rows="3" readonly="" >Enter your name</textarea>
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>
                    </form>
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase">Horizontal Form <?=$jumlah_data;?></span>
                    </div>
                    <div class="actions">
                        <div class="btn-group btn-group-devided" data-toggle="buttons">
                            <label class="btn btn-transparent dark btn-outline btn-circle btn-sm ">
